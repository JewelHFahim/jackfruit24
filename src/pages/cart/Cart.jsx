...
const Cart = () => {
  ...
  return (
    <section className="flex items-center bg-stone-200 lg:min-h-screen font-poppins dark:bg-gray-700 ">
            ...
            <div className="w-full px-4 mb-8 xl:w-8/12 xl:mb-0">
              ...
              <div className="py-4 mb-8 border-t border-b border-gray-200 dark:border-gray-700">
                ...
                products?.map((product, i)=>(
                    <div key={i} className="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
                    ...
                    <div className="hidden px-4 lg:block lg:w-2/12">
                      ...
                      <span className="text-xs text-gray-500 line-through dark:text-gray-400">
                        ${Number(product?.price) + Number(product?.price)  * .15}
                      </span>
                    </div>
