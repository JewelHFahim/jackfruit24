...
const ProductDetails = () => {
    ...
    const imgUrl ="https://onion24.com/product_images/1702207467_red%20dress.jpg";
    const imgStyle = "block border border-transparent dark:border-transparent dark:hover:border-blue-300 hover:border-blue-300"
                ...
                <div className="w-full px-4 md:w-1/2 ">
                    <div className="sticky top-0 z-50 overflow-hidden ">
                        <div className="relative mb-6 lg:mb-10 lg:h-2/4 ">
                            <img src={imgUrl} alt="" className="object-cover w-full lg:h-full"/>
                        </div>
                        <div className="flex-wrap hidden md:flex ">
                            <div className="w-1/2 p-2 sm:w-1/4">
                                <a href="#" className={imgStyle}>
                                    <img src={imgUrl} alt="" className="object-cover w-full lg:h-20"/>
                                </a>
                            </div>
                            <div className="w-1/2 p-2 sm:w-1/4">
                                <a href="#" className={imgStyle}>
                ...
                <div className="w-full px-4 md:w-1/2 ">
                    <div className="lg:pl-20">
                        ...
                        <div className="mb-8 ">
                            ...
                            <h2 className="max-w-xl mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl"> RED LADIES DRESS </h2>
                            ...
                            <p className="inline-block mb-8 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>$100.99</span>
                                <span
                                    className="text-base font-normal text-gray-500 line-through dark:text-gray-400">$150.99</span>
                            </p>
