...
const NewProducts = () => {
  const catStyle = "hover:text-red-700 hover:underline transition-all duration-200";
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        <h1 className="text-[28px] font-bold uppercase">New Products</h1>
          ...
          <ul className="flex items-center gap-x-2 lg:gap-x-4 text-slate-700 font-medium">
            <li> <a href="" className={catStyle}> Latops </a> </li>
            <li> <a href="" className={catStyle}> SmartPhones </a> </li>
            <li> <a href="" className={catStyle}> Cameras </a> </li>
            <li> <a href="" className={catStyle}> Accessories </a> </li>
          </ul>
      </div>
