  ...
  return (
    <div className="w-[260px] h-[380px] bg-white flex flex-col productcard hover:border-[3px] border-transparent hover:border-red-600 shadow-md">
      ...
      <div className="addTocartBtn flex justify-center items-center">
        <button className="text-white px-7 py-[5px] lg:py-[7px] rounded-[30px] bg-red-700 uppercase font-medium flex justify-center items-center gap-2 hover:bg-white hover:border-red-600 border-2 border-transparent hover:text-red-600 transition-all duration-200">
